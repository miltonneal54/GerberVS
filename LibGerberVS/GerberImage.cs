...
namespace GerberVS
{
    ...
    public class GerberImage
    {
        ...
        /// </summary>
        public GerberImageInfo ImageInfo { get; set; }

        /// <summary>
        /// The type of file (RS274X, drill).
        /// </summary>
        public GerberFileType FileType { get; set; }

        /// <summary>
        /// // List of all apertures used.
        /// </summary>
        public Aperture[] ApertureArray { get; set; }

        /// <summary>
        /// The layer formating information.
        /// </summary>
        public GerberFormat Format { get; set; }

        /// <summary>
        /// RS274X statistics for the layer.
        /// </summary>
        public GerberFileStats GerberStats { get; set; }

        /// <summary>
        /// Excellon drill statistics for the layer.
        /// </summary>
        public DrillFileStats DrillStats { get; set; }
